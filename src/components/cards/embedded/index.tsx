...
const ECard: React.FC<ECardProps> = ({ title, content, src }) => {
  return (
    <div className="w-60 bg-gradient-to-l from-slate-800 to-slate-600 text-slate-100 border-2 border-black grid grid-cols-2 justify-center p-4  gap-4 rounded-lg shadow-lg shadow-black">
